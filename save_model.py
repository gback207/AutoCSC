...
cnn1 = torch.load(r'C:\Users\brian\OneDrive\바탕 화면\한과영 기타\IDEV\AutoCSC\cnn1.pt')
criterion1 = torch.nn.CrossEntropyLoss()
optimizer1 = optim.Adagrad(cnn1.parameters(), lr=0.001)

cnn2 = torch.load(r'C:\Users\brian\OneDrive\바탕 화면\한과영 기타\IDEV\AutoCSC\cnn2.pt')
criterion2 = torch.nn.CrossEntropyLoss()
optimizer2 = optim.Adagrad(cnn2.parameters(), lr=0.001)

cnn3 = torch.load(r'C:\Users\brian\OneDrive\바탕 화면\한과영 기타\IDEV\AutoCSC\cnn3.pt')
criterion3 = torch.nn.CrossEntropyLoss()
optimizer3 = optim.Adagrad(cnn3.parameters(), lr=0.001)

cnn4 = torch.load(r'C:\Users\brian\OneDrive\바탕 화면\한과영 기타\IDEV\AutoCSC\cnn3.pt')
criterion4 = torch.nn.CrossEntropyLoss()
optimizer4 = optim.Adagrad(cnn4.parameters(), lr=0.001)
